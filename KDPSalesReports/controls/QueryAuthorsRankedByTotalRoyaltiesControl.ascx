<%@ Control Language="VB" AutoEventWireup="false" CodeFile="QueryAuthorsRankedByTotalRoyaltiesControl.ascx.vb" Inherits="controls_QueryAuthorsRankedByTotalRoyaltiesControl" %>
