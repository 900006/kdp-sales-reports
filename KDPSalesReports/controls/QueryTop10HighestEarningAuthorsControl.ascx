<%@ Control Language="VB" AutoEventWireup="false" CodeFile="QueryTop10HighestEarningAuthorsControl.ascx.vb" Inherits="controls_QueryTop10HighestEarningAuthorsControl" %>
